...
exports.handler = async function(event) {
    ...
    try {
        ...
        // **MEJORA CLAVE**: Verificación más robusta para ignorar solicitudes vacías.
        if (!text || typeof text !== 'string' || text.trim() === '') {
            console.log(`Solicitud para la página ${page} ignorada por falta de texto.`);
            // Devuelve un array vacío para que el proceso continúe sin errores.
            return {
                statusCode: 200,
                body: JSON.stringify([]),
            };
